...
#include <iomanip>
using namespace std;
double angleInput(double);
double powderInput(double);
int main(int argc, char* argv[]){
   ...
   do{
      angle = angleInput(angle);
      gunpowder = powderInput(gunpowder);
      xVel = gunpowder * 30;
...
double angleIntput(double anAngle){
...
double powderInput(double powder){
